...
class Vigenere extends StatefulWidget {
  ...
  @override
  State<Vigenere> createState() => _CaesarCipherState();
}

class _CaesarCipherState extends State<Vigenere> {
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  filled: true,
                  fillColor: Color.fromARGB(255, 8, 152, 152),
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() {
                    ...
                    cipherText = allCaesars.encryptVigenere(plaintext, key);
                  });
                },
