...
class RowTransposition extends StatefulWidget {
  const RowTransposition({Key? key}) : super(key: key);

  @override
  State<RowTransposition> createState() => _CaesarCipherState();
}

class _CaesarCipherState extends State<RowTransposition> {
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() {
                    ...
                    cipherText = allCaesars.encryptRowTransposition(plaintext, key);
                  });
                },
